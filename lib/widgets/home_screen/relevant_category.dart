...
class RelevantCategory extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RelevantCategory> createState() => _RelevantCategoryState();
}

class _RelevantCategoryState extends ConsumerState<RelevantCategory> {
  final Map<int, bool> _loadingStates = {};
  List<Category> relevantCategory = [];
  CategoryService get check => ref.read(categoryServiceProvider);
  ...
  Future<void> getCategory() async {
    relevantCategory = await check.getCategories();
    setState(() {});
  }
