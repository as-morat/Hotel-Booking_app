  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        margin: const .symmetric(horizontal: 12, vertical: 16),
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Column(
          ...
          children: [
            Icon(Icons.wallet_rounded, size: 100, color: Colors.orange),
            SizedBox(height: 20),
            Text(
              'Wallet Page',
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.person_rounded, size: 100, color: Colors.purple),
            SizedBox(height: 20),
            Text(
              'Profile Page',
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
